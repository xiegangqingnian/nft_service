...
const (
	...
	FilesDownloadFailCode int    = -400253
	FilesDownloadFailMsg  string = "文件下载失败,或无效的cid"
	...
	//短信验证码
	SmsSendfrequentMsg  string = "手机短信验证码发送频繁"
	SmsSendfrequentCode int    = -400400

	RegisterDuplicateAccountMsg  string = "该手机已注册"
	RegisterDuplicateAccountCode int    = -400500

	BrandUserIDInvalidMsg  string = "无效的用户id"
	BrandUserIDInvalidCode int    = -400501

	UserAlreadyLockedMsg  string = "用户已锁定"
	UserAlreadyLockedCode int    = -400502
	UserNotLockedMsg      string = "用户未锁定"
	UserNotLockedCode     int    = -400503
)
